...
def load_and_preprocess_data(data_root=None):
    ...
    require_paths([tensor_dir / "train.parquet", tensor_dir / "val.parquet"], "MLP optimization")
...
def run_optimization(data_root=None):
    ...
    X_train_scaled, y_train, X_val_scaled, y_val = load_and_preprocess_data(paths.data_root)
    ...
    write_run_manifest(paths.outputs_root, "clean_mlp_optimization", paths.data_root)
