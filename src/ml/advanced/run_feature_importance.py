...
def run_feature_importance():
    ...
    if os.path.exists(xgb_model_path):
        ...
        plot_path_xgb = os.path.join(plots_dir, "feature_importance_xgboost.pdf")
        plot_feature_importance(xgb_importances, feature_names, "Permutation Feature Importance (XGBoost)", plot_path_xgb)
        logger.info(f"Saved XGBoost Feature Importance to {plot_path_xgb}")
    else:
    ...
    if os.path.exists(mlp_params_path) and os.path.exists(mlp_model_path):
        ...
        plot_path_mlp = os.path.join(plots_dir, "feature_importance_mlp.pdf")
        plot_feature_importance(mlp_importances, feature_names, "Permutation Feature Importance (MLP)", plot_path_mlp)
        logger.info(f"Saved MLP Feature Importance to {plot_path_mlp}")
    else:
